...
class IndexController extends AbstractActionController
{
    ...
    protected $table, $sendForm, $message, $user;

    public function __construct(
        MessagesModel $messagesModel,
        FormInterface $setForm,
        UserEntity $userEntity
    )
    {
        $this->setTable($messagesModel);
        $this->setSendForm($setForm);
    ...
    public function sendAction()
    {
        ...
        if ($request->isPost()) {
            $this->sendForm->bind(new MessageEntity());
            ...
            if (!$this->sendForm->isValid()) {
                ...
                if ($this->table->save($message)) {
                    ...
                    $status = self::SEND_FAIL . '<br>' . implode('<br>', $this->flashMessenger->getMessages());
                }
            }
        }
    ...
    public function setTable(MessagesModel $table)
    {
        $this->table = $table;
    }
